        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultTaxRate = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 19.00m),
                    CurrencyCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false, defaultValue: "COP"),
                    CurrencySymbol = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false, defaultValue: "$"),
                    LowStockThresholdDefault = table.Column<int>(type: "integer", nullable: false, defaultValue: 10),
                    AllowNegativeStock = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    EnableAuditNotifications = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumStock = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufacturingDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Warehouses_Users_AdminUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Categories_Warehouse_Name",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_InventoryMovements_MovementNumber",
                table: "InventoryMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Products_Warehouse_Sku",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Suppliers_Warehouse_TaxId",
                table: "Suppliers",
